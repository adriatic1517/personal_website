...
with open('~/app/personal_website/pashto/data/Pashto_Raverty_full.json') as json_file:
...
df = pd.read_json('~/app/personal_website/pashto/data/Pashto_Raverty_full.json').transpose()
